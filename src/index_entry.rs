...
impl IndexEntry {
	...
	pub fn get_frequency(&self) -> f64 {
		self.num_occurrences.fetch_add(0, Ordering::Relaxed) as f64 / self.total_words.fetch_add(0, Ordering::Relaxed) as f64
	}
	...
	pub fn to_string(&self) -> String {
		let mut out = format!("{}    Frequency: {}    Occurrences: ", self.get_word(), self.get_frequency());
